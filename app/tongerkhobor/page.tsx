...
      imageAreaY = 550 // টেক্সট এরিয়া ৫৫০px পর্যন্ত
...
      // ইমেজের ওপর গ্রেডিয়েন্ট বা ওভারলে
      if (template === 'dark_magazine') {
...
    // ৫. টেক্সট ড্রয়িং (Headline, Date, Category)
    const margin = 60
